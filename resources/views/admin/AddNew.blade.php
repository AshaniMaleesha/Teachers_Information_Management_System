                                    ...
                                    <div class="card" style="font-weight:bold;background-color:#0b2c4d;color:white;font-size:16px;">
                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input type="date" name="birthday" class="form-control datepicker" style="background-color: white"/>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="religion" id="religion" class="form-control" style="padding: 7px;">
                                                    <option selected="selected">---</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="ethnic" id="ethnic" class="form-control" style="padding: 7px;">
                                                    <option selected="selected">---</option>
